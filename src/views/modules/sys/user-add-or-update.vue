...
<!--      </el-form-item>-->
      ...
      <el-form-item label="角色" size="mini" prop="roleIdList">
        <el-checkbox-group v-model="dataForm.roleIdList" @change="checkboxChange">
          <el-checkbox v-for="role in roleList" :key="role.roleId" :label="role.roleId">{{ role.roleName }}</el-checkbox>
        </el-checkbox-group>
      </el-form-item>
<!--      <el-form-item size="mini" label="路局线路选择" v-show="adminFlag">-->
<!--        <el-tree-->
<!--          :data="railStation"-->
...
<script>
  ...
  export default {
    ...
    methods: {
          ...
          if (this.dataForm.id) {
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                if (data.user.roleIdList.indexOf(1) !== -1) {
                  roleListFlag = true
                }
                if (roleListFlag) {
      ...
      checkboxChange () {
        let flag = this.dataForm.roleIdList.indexOf(1)
        if (flag !== -1) {
          this.adminFlag = false
          // 已选中超级管理员
        } else {
